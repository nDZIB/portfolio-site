      ...
      <main ref={bodyEltRef} className={`body`}>
        <div className={`resume`}>
          <figure className={`bio`}>
            <img className={`avatar`} src={portfolio.avatar.url} />
          ...
          <div className={`summary`}>
            ...
            <div className={`section numerics`}>
              ...
              <button href={portfolio.cv.url} className={`download-cv-btn`}><span>Download C.V</span></button>
            </div>
                  ...
                  portfolio.experiences.map(experience => {
                    return <li className={`experience-item`}>
                      <div className={`experience-item-summary`}>
                        ...
                        <img className={`company-logo`} title={experience.company} src={experience.companyLogo.url} />
